            ...
            <div class="col-lg-4">
               <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ Lang::get('administrable-livenews::translations.label') }}</li>
                    </ol>
                </nav>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3 class="card-title">{{ Lang::get('administrable-livenews::translations.label') }}</h3>
                    <div class="btn-group float-right">
                        <a href="{{ back_route('extensions.livenews.livenews.create') }}" class="btn  btn-primary"> <i
                                class="fa fa-plus"></i> {{ Lang::get("administrable-livenews::translations.default.add") }}</a>

                        <a href="#" class="btn btn-danger d-none" data-model="{{ config('administrable-livenews.models.livenews') }}" id="delete-all">
                            <i class="fa fa-trash"></i> {{ Lang::get('administrable-livenews::translations.default.deleteall') }}</a>
                    </div>
                </div>
